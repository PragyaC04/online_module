...
<div class="container">
  <h3>Test Number: <?php echo e($c); ?></h3>
  ...
  <div class="tab-content">
    ...
    <div id="sect1" class="tab-pane fade in active">
       <form action = "<?php echo e(route('qualitative.add',['count'=>$c])); ?>" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>"/>
    <input type="hidden" name="count" value="<?php echo e($c); ?>">
    <div class="card">
        <div class="card-header">
            ...
            <div class="form-group">
                <label>SetId</label>
                <input type="text" name="sid" class="form-control" placeholder="enter set id" value="<?php echo e($c); ?>" readonly>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="card-footer">
            <button type="submit" name="submit" class="btn btn-primary">Save data</button>
            <button type="button" onclick="window.location='<?php echo e(url ("/new")); ?>'" class="btn btn-primary">Back</button>
            <button type="button" onclick="window.location='<?php echo e(url ("/viewa")); ?>'" class="btn btn-primary">View</button>
        </div>
    </div>
    </form>
    </div>
    ...
    <div class="card">
        ...
        <div class="card-footer">
            <button type="submit" name="submit" class="btn btn-primary">Save data</button>
            <button type="button" onclick="window.location='<?php echo e(url ("/new")); ?>'" class="btn btn-primary">Back</button>
            <button type="button" onclick="window.location='<?php echo e(url ("/viewco")); ?>'" class="btn btn-primary">View</button>
        </div>
    </div>
    </form>
    </div>
...
<?php /**PATH C:\xampp\htdocs\onlinemodule\resources\views/addtest.blade.php ENDPATH**/ ?>